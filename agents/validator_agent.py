...
class Validator_Agent(AgentBase):
        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "You are an AI assistant that validates research articles for accuracy, completeness, "
            ...
            },
            {
                "role": "user",
                "content": (
                    "Given the topic and the research article below, assess whether the article comprehensively covers "
                    "the topic, follows a logical structure, and maintains academic standards.\n"
                    "Provide a brief analysis and rate the article on a scale of 1 to 5, where 5 indicates excellent quality.\n\n"
                    f"Topic: {topic}\n\n"
                    f"Article:\n{article}\n\n"
                    "Validation:"
